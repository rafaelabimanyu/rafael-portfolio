      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="space-y-12">
          {CATEGORIES.map((category, catIdx) => {
            ...
            return (
              <div key={category.title} ref={catRef}>
                {/* Category Header */}
                <div

...
const PROJECTS_DATA = [
  {
    ...
    tags: [
      { label: "SaaS Billing System", color: "#06b6d4" },
      { label: "Invoice Management", color: "#a855f7" },
      { label: "Database Optimization", color: "#34d399" },
      { label: "Clean UI", color: "#ec4899" },
    ],
  ...
  },
  {
    ...
    tags: [
      { label: "Academic Portal", color: "#a855f7" },
      { label: "Modular Structure", color: "#06b6d4" },
      { label: "Role-Based Access Control", color: "#34d399" },
      { label: "Interactive UI", color: "#ec4899" },
    ],
    techStack: ["Laravel", "PHP", "MySQL", "Blade Templates", "JavaScript"],
    accent: "#a855f7",
